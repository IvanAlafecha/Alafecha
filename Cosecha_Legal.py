...
app.layout = html.Div([
    ...
    html.Div(
        children=[
            html.Img(src='assets/Arco.png', style={
                'position': 'absolute',
                'top': '1px',
                'left': '10px',
                'width': '150px',
            }),
            html.Img(src='assets/lema.jpg', style={
                'position': 'absolute',
                'top': '1px',  # Ajustar esta propiedad según la altura del Dropdown
                'right': '1px',  # Ajustar para alinearlo a la derecha
                'width': '250px',
            })
        ],
    ...
    dcc.Dropdown(
        ...
        style={'width': '80%'}  # Esto es opcional, puedes ajustar el tamaño del Dropdown si es necesario
    ),
...
def update_graph(selected_labels):
    ...
    fig.update_layout(
        ...
        height=800,  # Ajustar el tamaño del gráfico para que sea más grande
